...
class MultiSpectralAttentionLayer(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        x_pooled = x
        print ("x shape in MultiSpectralAttentionLayer:    ", x.shape)
...
class MultiSpectralDCTLayer(nn.Module):
    ...
    def get_dct_filter(self, tile_size_x, tile_size_y, mapper_x, mapper_y, channel):
        ...
        print ("dctfilter:    ", dct_filter.shape)                
        return dct_filter


class DDLNet(nn.Module):
    def __init__(self, num_class, channel_list=[128, 256, 512, 512], transform_feat=128):   #original list but i changed it: channel_list=[64, 128, 256, 512]
        super(DDLNet, self).__init__()


        c2wh = dict([(128,128), (256,64), (512,32) ,(512,16)])   #        c2wh = dict([(64,128), (128,28), (256,14) ,(512,7)])
