...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Codes Testing things//test_15-3-2025_CGNet_withChF_Decoder - 2//checkpoints//checkpoint4-BCE-50epochs//ResUnet10.pth"))
    model.eval()
    test_results_path="E://VS Codes Testing things//test_15-3-2025_CGNet_withChF_Decoder - 2//test_results//test_results4-BCE-50epochs"
    ...
    with torch.no_grad():
        for _, data in enumerate(test_loader):
            ...
            prediction = torch.where(probs>0.825,1.0,0.0)
